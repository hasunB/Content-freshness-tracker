...
class FR_admin {
    ...
    ?>
        <div class="wrap">
            <h1 class="wp-heading-inline"><?php esc_html_e( 'Freshness Tracking', 'fresh-reminder' ); ?></h1>
            
            <!-- Stats Cards -->
            <div class="row gx-3 my-0">
                <!-- Total Stale Posts -->
                <div class="col-md-4">
                    <div class="card shadow-sm stat-card h-80 theme-outline">
                        <div class="card-body">
                                    ...
                                    <tr data-post-id="<?php echo esc_attr( $post->ID ); ?>" data-status="<?php echo $post->reviewed ? 'reviewed' : 'unreviewed'; ?>">
                                        ...
                                        <td class="align-middle text-center">
                                            <?php if ( $post->post_type == "post" ) : ?>
                                                <span class="theme-badge bg-post"><?php esc_html_e( 'Post', 'fresh-reminder' ); ?></span>
                                            <?php elseif ( $post->post_type == "page" ) :?>
                                                <span class="theme-badge bg-page"><?php esc_html_e( 'Page', 'fresh-reminder' ); ?></span>
                                            <?php elseif ( $post->post_type == "product" ): ?>
                                                <span class="theme-badge bg-product"><?php esc_html_e( 'Product', 'fresh-reminder' ); ?></span>
                                            <?php else : ?>
                                                <span class="theme-badge bg-media"><?php esc_html_e( 'Media', 'fresh-reminder' ); ?></span>
                                            <?php endif; ?>
                                        </td>
                                        ...
                                        <td class="align-middle text-center">
                                            <?php if ( $post->reviewed ) : ?>
                                                <span class="badge bg-success-subtle text-success status-badge"><?php esc_html_e( 'Reviewed', 'fresh-reminder' ); ?></span>
                                            <?php else : ?>
                                                <span class="badge bg-danger-subtle text-danger status-badge"><?php esc_html_e( 'Stale', 'fresh-reminder' ); ?></span>
                                            <?php endif; ?>
                                        </td>
                                        <td class="align-middle text-center">
                                            <?php if ( $post->reviewed ) : ?>
                                                <button class="theme-btn bg-product fr-mark-unreview" data-post-id="<?php echo esc_attr( $post->ID ); ?>">
                                                    <i class="fas fa-undo me-1"></i>
                                                    <?php esc_html_e( 'Unmark Reviewed', 'fresh-reminder' ); ?>
                                                </button>
                                            <?php else : ?>
                                                <button class="theme-btn bg-post fr-mark-review" data-post-id="<?php echo esc_attr( $post->ID ); ?>">
                                                    <i class="fas fa-check me-1"></i>
                                                    <?php esc_html_e( 'Mark Reviewed', 'fresh-reminder' ); ?>
                                                </button>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
            ...
            <form method="post">
                ...
                <table class="form-table">
                    ...
                    <tr>
                        ...
                        <td><label><input type="checkbox" name="email_notify" value="1" <?php checked($settings['email_notify'], 1); ?> /> <?php esc_html_e('Send digest to selected roles', 'fresh-reminder'); ?></label></td>
                    </tr>
                    <tr>
    ...
    public static function dashboard_widget_render() {
        ...
        <div class="fr-dashboard-widget-content">
            ...
            <?php if ($unreviewed_posts_count > 0) : ?>
                <p class="mt-3 text-center"><a href="<?php echo esc_url(admin_url('admin.php?page=fr-home')); ?>" class="btn btn-primary"><?php esc_html_e('Review Stale Posts', 'fresh-reminder'); ?></a></p>
            <?php endif; ?>
        </div>
    <?php
    }
